        ...
        <div class="column middle">
            <div class="align-items-center justify-content-center row puzzle">
                ...
                <div class="align-items-center justify-content-center row">
                    <button class="submit-button" style="max-width:810px; margin-top: 2em;" @click="checkAndSubmit()">Submit</button>
                </div>
            </div>
        </div>
        <div class="column right">
            <div class="align-items-center justify-content-centre row">
...
export default {
    name: 'RenderPuzzleFed',
    components: {
        NavBar,
        StopwatchComp,
        Toggle
    },
    props: ['serverid', 'sudokuid'],
    data() {
        return {
    ...
    computed: {
        ...
        ...mapState('getAllPuzzlesFederation', { fed_puzzle: state => state.fed_puzzle, fed_solution: state => state.fed_solution })
    },
    methods: {
    ...
    mounted() {
        ...
        this.$store.commit('getAllPuzzlesFederation/getSpecificFedPuzzle', { server_id: this.serverid, sudoku_id: this.sudokuid });
        this.$store.commit('playPuzzle/initGridFed', { grid: this.fed_puzzle, solution: this.fed_solution });
